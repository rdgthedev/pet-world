...
namespace PetWorldOficial.Infrastructure.Migrations
{
    ...
    [Migration("20240930155854_CategoryIdRemovedFromSchedulling")]
    partial class CategoryIdRemovedFromSchedulling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetWorldOficial.Domain.Entities.Schedulling", b =>
                {
                    ...
                    b.HasOne("PetWorldOficial.Domain.Entities.Category", null)
                        .WithMany("Schedullings")
                        .HasForeignKey("CategoryId");
